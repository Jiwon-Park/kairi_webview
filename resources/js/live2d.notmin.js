...
, function(t, i, e) {
    ...
    (function(t) {
        !function() {
            ...
            function gt() {
                this.m = new Array(1.5,0,0,0,1.5,0,0,0,1)
            }
            function yt(t) {
                At || et.prototype.constructor.call(this, t)
            }
            ...
            mt.prototype._$Uo = function(t, i, e, r, o, n, s, _) {
                if (!(n < .01 && null == this.clipBufPre_clipContextMask)) {
                    ...
                    var h = 1 * this._$C0 * n
                      ...
                      , $ = 1 * this._$WL * n
                      , u = this._$lT * n;
                    var scale_vector = [1,1,1,1]
                    if (typeof l2d_scale === 'number')
                        scale_vector = [l2d_scale,l2d_scale,l2d_scale,1]
                    if (null != this.clipBufPre_clipContextMask) {
                        ...
                        a.uniform4fv(this.v_scale_Loc, scale_vector),
                        ...
                        a.uniform4fv(this.v_scale_Loc_Off, scale_vector),
            ...
            mt.prototype.initShader = function() {
                ...
                this.v_scale_Loc = t.getUniformLocation(this.shaderProgram, "v_scale"),
                ...
                this.v_scale_Loc_Off = t.getUniformLocation(this.shaderProgramOff, "v_scale")
            }
            ,
            ...
            mt.prototype.loadShaders2 = function() {
                ...
                !this.shaderProgramOff)
                    return !1;
                if (this.vertShader = this.compileShader(t.VERTEX_SHADER, "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;varying vec4       v_ClipPos;uniform vec4       v_scale;uniform mat4       u_mvpMatrix;void main(){    gl_Position = u_mvpMatrix * a_position * v_scale;    v_ClipPos = u_mvpMatrix * a_position * v_scale;    v_texCoord = a_texCoord;}"),
                !this.vertShader)
                    return _._$Ji("Vertex shader compile _$li!"),
                    !1;
                if (this.vertShaderOff = this.compileShader(t.VERTEX_SHADER, "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;varying vec4       v_ClipPos;uniform vec4       v_scale;uniform mat4       u_mvpMatrix;uniform mat4       u_ClipMatrix;void main(){    gl_Position = u_mvpMatrix * a_position * v_scale;    v_ClipPos = u_ClipMatrix * a_position * v_scale;    v_texCoord = a_texCoord ;}"),
                !this.vertShaderOff)
...
, function(t, i, e) {
    ...
    r.prototype.loadModelSetting = function(t, i) {
        ...
        o.Live2DFramework.getPlatformManager().loadBytes(t, function(t) {
            ...
            if (e.json.model.startsWith("Live2D/Card_"))
                e.json.layout = {
                    height: 1.4,
                    center_x: 0,
                    center_y: 0
